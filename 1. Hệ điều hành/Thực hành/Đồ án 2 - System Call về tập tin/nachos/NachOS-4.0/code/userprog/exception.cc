...
void handleSC_Seek()
{
    int seekPosition = kernel->machine->ReadRegister(4);
    int fId = kernel->machine->ReadRegister(5);

    kernel->machine->WriteRegister(2, SysSeek(seekPosition, fId));
