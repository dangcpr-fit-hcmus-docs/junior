...
declare @check int
Exec @check=sp_Them_Nhan_Vien '0001',N'Lê Long'
...
declare @check int
Exec @check=sp_Them_Nhan_Vien '',N''
print 'OUTPUT: ' + cast(@check as char(1))

declare @check int
Exec @check=sp_Them_Nhan_Vien '0002',N'Hoàng Xuân Huấn'
print 'OUTPUT: ' + cast(@check as char(1))



declare @check int
Exec @check=sp_Them_Nhan_Vien '0004',N'Nguyễn Bách Khá'
print 'OUTPUT: ' + cast(@check as char(1))

declare @check int
Exec @check=sp_Them_Nhan_Vien '0005',N'Phạm Lê Phú'
print 'OUTPUT: ' + cast(@check as char(1))
--2. Thêm 1 đôí tác
--Mô tả:
